...
const clientAt = html.indexOf("supabase-client.js?v=2");
const uiAt = html.indexOf("stitch-ui.js?v=24");
...
if (!/fitplan-v36/.test(serviceWorker)) failures.push("Versão do cache não foi incrementada");
